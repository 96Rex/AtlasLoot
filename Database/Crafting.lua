...
--------------------------------
	...
	GreenDragonM = {
		...
		{ 20296, "INV_Gauntlets_12", "=q3=绿龙鳞片护手", "=ds=#s9#, #a3#" },
	...
	BlackDragonM = {
		...
		{ 0, "", "", "" },
		{ 15051, "INV_Shoulder_01", "=q3=黑龙鳞片护肩", "=ds=#s3#, #a3#" },
		{ 15050, "INV_Chest_Plate06", "=q3=黑龙鳞片胸甲", "=ds=#s5#, #a3#" },
		{ 15052, "INV_Pants_03", "=q3=黑龙鳞片护腿", "=ds=#s11#, #a3#" },
		{ 16984, "INV_Boots_Plate_09","=q4=黑龙鳞片战靴", "=ds=#s12#, #a3#" },
	};
...
--龙鳞制皮
	Dragonscale1 = {
		...
		{ "s24655", "inv_gauntlets_12", "=q3=绿龙鳞片护手", "=ds=#sr# =so1=280 =so2=300 =so3=310 =so4=320" },
		{ "s19077", "inv_chest_chain_04", "=q3=蓝龙鳞片胸甲", "=ds=#sr# =so1=285 =so2=305 =so3=315 =so4=325" },
		{ "s19085", "inv_chest_plate06", "=q3=黑龙鳞片胸甲", "=ds=#sr# =so1=290 =so2=310 =so3=320 =so4=330" },
		...
		{ "s19107", "inv_pants_03", "=q3=黑龙鳞片护腿", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s24654", "inv_pants_mail_15", "=q3=蓝龙鳞片护腿", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s19094", "inv_shoulder_01", "=q3=黑龙鳞片护肩", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s19054", "inv_chest_chain_06", "=q3=红龙鳞片胸甲", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
		{ "s20855", "inv_boots_plate_09", "=q4=黑龙鳞片战靴", "=ds=#sr# =so1=300 =so2=320 =so3=330 =so4=340" },
...
--元素制皮
	Elemental1 = {
		...
		{ "s57012", "inv_chest_leather_08", "=q4=火怒护腿", "=ds=#sr# =so1=300 =so2=300 =so3=300 =so4=300" },
...
--制皮根据装备部位
	...
	LeatherPants1 = {
		{ "s2153", "inv_pants_wolf", "=q1=手工皮短裤", "=ds=#sr# =so1=15 =so2=45 =so3=60 =so4=75" },
		{ "s9064", "inv_pants_02", "=q2=褶皱皮短裤", "=ds=#sr# =so1=35 =so2=65 =so3=80 =so4=95" },
		{ "s3759", "inv_pants_02", "=q2=雕花皮短裤", "=ds=#sr# =so1=75 =so2=105 =so3=120 =so4=135" },
		{ "s9068", "inv_pants_02", "=q2=轻皮短裤", "=ds=#sr# =so1=95 =so2=125 =so3=140 =so4=155" },
		{ "s7133", "inv_pants_02", "=q2=优质皮裤", "=ds=#sr# =so1=105 =so2=130 =so3=142 =so4=155" },
		{ "s7135", "inv_pants_09", "=q2=黑皮短裤", "=ds=#sr# =so1=115 =so2=140 =so3=152 =so4=165" },
